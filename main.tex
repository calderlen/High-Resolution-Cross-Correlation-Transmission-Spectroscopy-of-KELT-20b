...
\begin{document}
    ...
    \begin{abstract}
        We present high-resolution cross-correlation transmission spectroscopy results from a lone observation of KELT-20b with the PEPSI spectrograph on the LBT. We detect Fe I, Fe II, Mg I, Na I, and Cr I and tentatively detect Ba II, Cu I, and Mn I among an inventory of 59 atoms, ions, and molecules. We phase-resolve the Doppler shifts of each detected species and present velocity offsets in ingress/egress, first/second-half, and three-exposure bins CCFs to highlight limb asymmetries and longitudinal variations in the atmosphere's wind structure. We find several high-confidence species redshifting with phase which serves to challenge current theory. We detail the potential drivers of observed phase asymmetries, providing evidence for several dynamical, chemical, and radiative mechanisms in KELT-20b by connecting our observation to general circulation models. We note the continued absence of molecular thermal inversion agents, with further support for atomic Fe I and Fe II as the low pressure absorbers. Due to KELT-20b's ionosphere, we probe vertical wind structures with phase-dependent velocity offsets between the lower-pressure Fe II ($15.5\sigma$) and deeper Fe I ($5.3\sigma$). We rudimentarily constrain the magnetic field of the magnetosphere of KELT-20b with the moderately heavy ion Ba II to accompany recent theory.
    ...
    \section{Introduction}\label{sec:intro}
        ...
        Ultra hot Jupiters (UHJs) represent an exceptional subclass of exoplanets, particularly amenable to atmospheric characterization. These planets have highly irradiated, often tidally locked atmospheres, with dayside temperatures exceeding 2200K. On the intensely hot dayside, molecular constituents dissociate into atomic and ionic species. These species are transported across the terminator—--marked by a significant day-night temperature contrast—--to the cooler nightside through various dynamical processes. The gaseous, puffy atmospheres of UHJs provide a unique environment to study chemical, radiative, and dynamical energy transport processes and their interactions. KELT-20b/MASCARA-2b is positioned favorably among the ultra hot Jupiter regime for extreme dynamics, with theoretical wind speeds up to $\sim5\,\text{kms}^{-1}$ \citep{Tan2019}. It was previously observed with the CARMENES \citep{CasasayasBarris2019, Nugroho2020, Kesseli2020}, EXPRES \citep{Hoeijmakers2020}, FIES \citep{BelloArufe2022}, and HARPS-N \citep{CasasayasBarris2019, Rainer2021, Langeveld2022, Sicilia2022} spectrographs. These observations have produced detections of Fe I, Fe II, Na I, Ca II, and tentative detections of Mg I and Cr II. This study focuses on the dynamics of KELT-20b, a crucial component of the energy budget in UHJ atmospheres.
...
\appendix  
   ...
   \section{Detections}\label{app:Detections}
        ...
        \begin{figure}
            ...
            \caption{Cross-correlation results for each detected and tentatively detected atomic species in our analysis.
            \textit{First panel}: CCFs of individual arms overlaid.
            \textit{Second panel}: $K_p-RV$ maps in the stellar rest frame. \textit{Third panel}: $K_p-\Delta V$ maps, shifted into the planetary rest frame. \textit{Fourth panel}: $SNR-\Delta V$ map at the $K_p$ corresponding to peak signal. This figure shows the maps, 1D CCFs, and line profiles for each species exceeding the ${3\sigma}$ tentative detection threshold. The offset of the center of the 1D CCF Gaussian from the planetary rest frame, $\Delta V$, denotes the line velocity.}
        \end{figure}
