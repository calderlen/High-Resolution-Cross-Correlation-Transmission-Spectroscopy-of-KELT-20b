...
\begin{document}
    ...
    \section{Methodology}\label{sec:Methodology}
        ...
        \subsection{Model Spectra}\label{subsec:Model Spectra}
            ...
            \begin{deluxetable*}{l l c c}
                \tablecaption{This table summarizes the planetary and stellar parameters relevant to our analysis. Sources: a:~\citet{Lund2017}; b:~\citet{Johnson2023}.\label{tab:parameters_summary}}
                \tablehead{
    ...
    \section{Results}\label{sec:Results}
        ...
        \begin{deluxetable*}{lcccccccc}
            \tablecaption{Summary of results for different spectrographs.}
            \tablehead{
                \colhead{} & 
...
\appendix  
    ...
    \section{Line Profiles of Each Arm}
         ...
         \begin{figure}
            ...
            \gridline{\fig{plots-updated/line-profile-overlaidarms/KELT-20b.20190504.combined.Sc II.line-profiles-overlaidarms.pdf}{0.3\textwidth}{}
   ...
   \section{${K_p-\Delta\!V}$ Maps and 1D CCFs}
        ...
        \begin{figure}
            ...
            \gridline{
                \fig{plots-updated/raw-ccfs/blue/KELT-20b.20190504.Co.blue.CCFs-raw.pdf}{0.3\textwidth}{\label{fig:raw-ccf-Mg-blue}}
        ...
        \begin{figure}
            ...
            \caption{This figure shows the $K_p-v_{sys}$ maps, 1D CCFs, and line profiles for each species exceeding the ${3\sigma}$ tentative detection threshold. The offset of the center of the 1D CCF Gaussian from the planetary rest frame, ${v_{sys}}=0$, denotes the line velocity.}
            \label{fig:Detections}
        \end{figure}
        
        
    \section{Line Dynamics}
        \begin{figure}\label{fig:enter-label}
            \centering
            \gridline{
                \fig{plots-updated/line-profile-asymmetries/blue/KELT-20b.20190504.blue.Mg.SNR-Gaussian-Asymmetry.pdf}{0.3\textwidth}{}
                \fig{plots-updated/line-velocity/KELT-20b.Mg.phase-binned+RVs.pdf}{0.3\textwidth}{\label{fig:wind-chars-Mg-blue}}
            }
            \gridline{
                ...
                \fig{plots-updated/line-velocity/KELT-20b.Fe.phase-binned+RVs.pdf}{0.3\textwidth}{\label{fig:wind-chars-Fe-combined}}
            }

            \gridline{
                \fig{plots-updated/line-profile-asymmetries/combined/KELT-20b.20190504.combined.Fe+.SNR-Gaussian-Asymmetry.pdf}{0.3\textwidth}{}     
                \fig{plots-updated/line-velocity/KELT-20b.Fe+.phase-binned+RVs.pdf}{0.3\textwidth}{\label{fig:wind-chars-FeII-combined}}
            }
            ...
            \gridline{                        
                ...
                \fig{plots-updated/line-velocity/KELT-20b.Cr.phase-binned+RVs.pdf}{0.3\textwidth}{\label{fig:wind-chars-CrI-combined}}
            }
            \gridline{                        
            ...
            \gridline{
                ...
                \fig{plots-updated/line-velocity/KELT-20b.Co.phase-binned+RVs.pdf}{0.3\textwidth}{\label{fig:wind-chars-Co-blue}}
            }
        \end{figure}
